...
<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
  <ul class="navbar-nav">
    ...
    <h3>Tampil Siswa</h3>  <a href="tambah_siswa.php" 
    class="btn btn-success">Tambah Siswa</a>
...
<tr>              
    ...
    class="btn btn-success">Ubah</a> | <a href="hapus_siswa.php?id_siswa=<?=$data_siswa['id_siswa']?>" 
