...
<nav class="navbar navbar-expand-sm bg-secondary navbar-dark">
  <ul class="navbar-nav">
    ...
    <h3>Tampil kelas</h3> <a href="tambah_kelas.php" 
    class="btn btn-success">Tambah Kelas</a>
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                <th>NO</th><th>Kelas</th><th>Jurusan</th>
            </tr>
        </thead>
        <tbody>
            <?php 
...
<tr>              
    ...
    <td><a class="btn btn-success">Ubah</a> | <a href="hapus_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>" 
